...
通用节日只是底盘。请从**上文的「故事记忆库」、角色卡、世界书、人物关系与既有剧情**里挑出**只属于这个故事**的年度日期。通常收录 **3-6 条**；素材不足可更少或为 0；故事素材非常丰富时最多 **8 条**，始终以证据为准。
- **收录门槛**：事件重要、难忘或推动过剧情，不等于纪念日；必须达到角色、组织或世界会在来年**主动标记、纪念、庆祝、悼念或举行仪式**的程度。
- **积极收录**：关系核心的重大初遇、立约、定情 / 婚姻、决裂、重逢、生死、身份或命运转折、重要忌日、组织成立、灾变或战争周年等（type 用 anniversary）；世界独有且有设定依据的年度习俗、地方节庆或阵营活动可用 custom / festival。
- **明确排除**：普通约会、普通同行、一次小胜负、小争执、短期任务节点；不得把同一里程碑的连续剧情步骤拆成多个周年。
若上文提供「故事记忆库」，从头到尾通读时间线；若是全新对话且没有足够素材，就不写专属日期。条目应具体贴合剧情，并尽量分散到不同月份。
...
「说明」是完整句，必须以合适的终止标点结束（如。！？.!? 或省略号）；若句末有闭合引号，终止标点要写在引号内。
...
${already}
【什么才够格立为纪念日 · 门槛必须高】只挑真正**够分量、值得每年一记**的里程碑，例如关系核心的重大初遇、立约、定情 / 婚姻、决裂、重逢、生死、身份 / 命运转折、重要忌日、组织成立、灾变 / 战争周年。判断标准：
- **年度行为标准**：角色或相关群体会不会在来年主动标记、纪念、庆祝、悼念这一天，或举行相应仪式？只是记得、在意或对剧情重要，仍不自动够格。
- **宁缺毋滥，这不是流水账**：普通约会、普通同行、日常饭局、小胜负、小争执和短期任务节点不够格；同一里程碑的连续步骤只算一个纪念日，不得拆分换名重复。
- **必须确有其事**：只从剧情 /【故事记忆库】/ 世界书 / 角色卡里**真实发生过**的事件取材，且能定位到具体或可合理推断的日期。凭空编造的、尚未发生的、只是"可能会怎样"的，一律不要。
- **最多 ${cap} 条，通常 0-2 条**。真没有够格的新里程碑，就**一条都不要写**、直接输出空的 <almanac_widget></almanac_widget>——补录不到东西是完全正常、甚至常见的结果，**绝不能为凑数硬编**。

【日期与网格】每条给出 ${gridLine}；单日纪念 days=1。displayDate 填该世界观下的风味日期名（如"两人初遇之日""断桥重逢日"），与"M月D日"无异则留空。

【说明（每条最后一段·单行不换行）】交代：纪念的是哪段剧情 / 哪个节点、涉及谁、为何值得每年一记，让人一看就知道来龙去脉。说明必须写成以合适终止标点结束的完整句；若句末有闭合引号，终止标点要写在引号内。

【理想输出结构（没有够格的就输出空 widget，不要解释）】
<almanac_widget>
